...
#ifndef HATSCHET_SATSCCRATIISCHEDULER_H
#define HATSCHET_SATSCCRATIISCHEDULER_H
...
namespace HatScheT {
	class SATSCCRatIIScheduler : public RationalIISchedulerLayer {
	public:
	...
	private:
		...
		int sccGraphMaxLat;
		std::vector<std::map<Vertex*, int>> relativeSchedule;
		...
		std::map<int, int> deltaMins;
		void calcDeltaMins();
	};
}
#endif //USE_CADICAL
#endif //HATSCHET_SATSCCRATIISCHEDULER_H
