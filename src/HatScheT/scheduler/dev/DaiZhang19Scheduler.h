...
namespace HatScheT {
  ...
  private:
    ...
    /*!
     * Finished Basic Supergraphs generated by the buildSupergraph Methode to determine a relative schedule. And the Map
     * which maps the Vertices to the Vertices in the original Graph.
     */
    vector <std::pair<Graph*, map<Vertex*, Vertex*>>> basicSupergraphs;


    /*!
     * Finished Complex Supergraphs generated by the buildSupergraph Methode to determine a relative schedule.And the Map
     * which maps the Vertices to the Vertices in the original Graph.
     */
    vector <std::pair<Graph*, map<Vertex*, Vertex*>>> complexSupergraphs;
