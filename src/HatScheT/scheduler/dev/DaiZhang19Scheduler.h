...
namespace HatScheT {
  ...
  private:
    ...
    /*!
     * Finished Basic Supergraphs generated by the buildSupergraph Methode to determine a relative schedule.
     */
    vector <Graph*> basicSupergraphs;


    /*!
     * Finished Complex Supergraphs generated by the buildSupergraph Methode to determine a relative schedule.
     */
    vector <Graph*> complexSupergraphs;
