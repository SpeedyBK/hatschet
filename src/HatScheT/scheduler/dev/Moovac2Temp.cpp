...
namespace HatScheT
{
  ...
  Moovac2Temp::Moovac2Temp(Graph &g, ResourceModel &resourceModel, std::list<std::string>  solverWishlist, int II)
  ...
  void Moovac2Temp::resetContainer()
  {
      this->solver->reset();
      this->mi.clear();
  ...
  void Moovac2Temp::setUpSolverSettings()
  {
  ...
  void Moovac2Temp::setMaxLatency() {
      //case unlimited
  ...
  void Moovac2Temp::constructProblem()
  {
      this->setMaxLatency();
  ...
  void Moovac2Temp::setObjective()
  {
      ...
      if (!disableObj) {
          ...
          cout << "MoovacScheduler::Minimize Objective Disabled!" << endl;
      }
  }

/*  void Moovac2Temp::schedule()
  {
      this->timeouts = 0;
      this->totalTime = 0;
      this->II = this->minII;
  ...
  void Moovac2Temp::fillSolutionStructure()
  {
  ...
  void Moovac2Temp::setVectorVariables()
  {
      for(std::set<Vertex*>::iterator it = this->g.verticesBegin(); it != this->g.verticesEnd(); ++it) {
          Vertex* v = *it;
          int id = v->getId();
  ...
  void Moovac2Temp::setSourceVerticesToZero()
  {
      for(std::set<Vertex*>::iterator it = this->g.verticesBegin(); it != this->g.verticesEnd(); ++it) {
          Vertex* v = *it;
  ...
  void Moovac2Temp::setGeneralConstraints()
  {
      //5
  ...
  std::map<Edge*,int> Moovac2Temp::getLifeTimes()
  {
  ...
  std::map<const Vertex *, int> Moovac2Temp::getBindings()
  {
  ...
  int Moovac2Temp::getNoOfMuxInputs()
  {
  ...
  int Moovac2Temp::getNoOfImplementedRegisters()
  {
      if (this->scheduleFound==false) return -1;
  ...
  void Moovac2Temp::setModuloAndResourceConstraints()
  {
      this->mi.resize(0);
